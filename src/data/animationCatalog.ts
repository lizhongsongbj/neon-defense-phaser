...
const moveAssets:Record<string,string>={eve:'/assets/animations/enemies/boss-eve-9-move.webp?v=airship-motion-20260826',enforcer:'/assets/animations/enemies/boss-adam-smasher-move.webp?v=rebuilt-heavy-motion-20260826','adam-smasher':'/assets/animations/enemies/boss-adam-smasher-move.webp?v=rebuilt-heavy-motion-20260826',gang:'/assets/animations/enemies/enemy-01-gang-cyborg-side45-move-fixed-size.webp?v=fixed-character-size-20260825',riot:'/assets/animations/enemies/enemy-02-riot-mech-move-fixed-size.webp?v=fixed-character-size-20260825',ninja:'/assets/animations/enemies/enemy-03-phase-ninja-move-fixed-size.webp?v=fixed-character-size-20260825',aerostat:'/assets/animations/enemies/enemy-04-corporate-airship-fly.webp',devourer:'/assets/animations/enemies/enemy-05-data-devourer-move.webp',faraday:'/assets/animations/enemies/enemy-06-electromagnetic-riot-move.webp?v=generated-crawl-20260825',neurohound:'/assets/animations/enemies/enemy-08-neuro-hound-move.webp?v=generated-crawl-20260825',matriarch:'/assets/animations/enemies/enemy-09-tissue-matriarch-move.webp?v=no-color-lines-20260824',bonebreaker:'/assets/animations/enemies/enemy-10-bonebreaker-move.webp?v=generated-crawl-20260825',hijacker:'/assets/animations/enemies/enemy-07-hijack-hovercraft-fly.webp?v=generated-flight-20260825'}
const actionAssets:Record<string,string>={enforcer:'/assets/animations/enemies/boss-adam-smasher-attack.webp?v=rebuilt-heavy-motion-20260826','adam-smasher':'/assets/animations/enemies/boss-adam-smasher-attack.webp?v=rebuilt-heavy-motion-20260826',riot:'/assets/animations/enemies/enemy-02-riot-mech-attack.webp?v=regenerated-attack-20260825',ninja:'/assets/animations/enemies/enemy-03-phase-ninja-attack.webp?v=regenerated-attack-20260825',neurohound:'/assets/animations/enemies/enemy-08-neuro-hound-attack.webp?v=no-color-lines-20260824',matriarch:'/assets/animations/enemies/enemy-09-tissue-matriarch-attack.webp?v=no-color-lines-20260824',bonebreaker:'/assets/animations/enemies/enemy-10-bonebreaker-attack.webp?v=no-color-lines-20260825',aerostat:'/assets/animations/enemies/enemy-04-corporate-airship-attack-generated.webp',devourer:'/assets/animations/enemies/enemy-05-data-devourer-attack-generated.webp',faraday:'/assets/animations/enemies/enemy-06-electromagnetic-riot-attack-generated.webp',hijacker:'/assets/animations/enemies/enemy-07-hijack-hovercraft-fly.webp?v=full-body-safe-attack-20260826',eve:'/assets/animations/enemies/boss-eve-9-stage-2-attack.webp?v=runtime-stage-attack-20260826'}
const runtimePreviewFrames:Record<string,readonly string[]>={}
const deathAssets:Record<string,string>={enforcer:'/assets/animations/enemies/boss-adam-smasher-death.webp?v=rebuilt-heavy-motion-20260826','adam-smasher':'/assets/animations/enemies/boss-adam-smasher-death.webp?v=rebuilt-heavy-motion-20260826',gang:'/assets/animations/enemies/enemy-01-gang-cyborg-death-kneel-8f.webp?v=kneeling-death-8f-20260825-v2',riot:'/assets/animations/enemies/enemy-02-riot-mech-death.webp?v=generated-death-20260825',ninja:'/assets/animations/enemies/enemy-03-phase-ninja-death-transparent.webp?v=transparent-white-v2-20260826',aerostat:'/assets/enemies/generated-raw-selected/enemy-04-corporate-airship-base-cutout.png?v=original-death-base-20260826',devourer:'/assets/enemies/generated-raw-selected/enemy-05-data-devourer-base-cutout.png?v=original-death-base-20260826',faraday:'/assets/enemies/new/enemy-06-electromagnetic-riot.png?v=original-death-base-20260826',hijacker:'/assets/enemies/new/enemy-07-hijack-hovercraft.png?v=original-death-base-20260826',neurohound:'/assets/animations/enemies/enemy-08-neuro-hound-death.webp?v=no-color-lines-20260824',matriarch:'/assets/animations/enemies/enemy-09-tissue-matriarch-death.webp?v=no-color-lines-20260824',bonebreaker:'/assets/animations/enemies/enemy-10-bonebreaker-death.webp?v=no-color-lines-20260825'}
const enemies:AnimationCatalogEntry[]=enemySeeds.flatMap(seed=>[
 {id:`${seed.id}-${seed.id==='aerostat'||seed.id==='hijacker'||seed.id==='eve'?'fly':'walk'}`,category:'enemy',family:seed.family,name:seed.family,level:'移动',action:seed.id==='aerostat'||seed.id==='hijacker'||seed.id==='eve'?'飞行':'行走',description:seed.move,timeline:'启动 → 稳定移动 → 受击反馈 → 继续推进',referenceImage:seed.image,previewAsset:moveAssets[seed.id],status:moveAssets[seed.id]?'available':'planned',motion:seed.id==='aerostat'||seed.id==='hijacker'||seed.id==='eve'?'fly':'walk',accent:seed.accent,tags:[seed.family,'移动']},
 {id:`${seed.id}-attack`,category:'enemy',family:seed.family,name:seed.family,level:'攻击',action:seed.id==='gang'?'举枪点射':'攻击',description:seed.id==='gang'?'帮派义体兵压低重心，将步枪从巡逻姿态抬至肩线，完成短促三连点射并承受真实后坐。':seed.id==='riot'?'防暴镇压机降低机械重心，宽脚撑地，以胸前重盾向前冲撞并抬起警棍准备补击。':seed.id==='ninja'?'相位忍者从疾走姿态急停转髋，以低重心完成横向能量刀斩击并迅速回收。':seed.attack,timeline:seed.id==='gang'?'发现目标 → 双手举枪贴肩 → 瞄准锁定 → 三连点射 → 后坐复位 → 放低枪口':seed.id==='riot'?'锁定目标 → 液压下沉 → 重盾前推 → 冲撞命中 → 警棍回摆 → 复位':seed.id==='ninja'?'相位接近 → 前脚落地 → 转髋拔刀 → 水平斩击 → 刀光消散 → 回收架势':'锁定 → 动作蓄力 → 命中 → 收势',referenceImage:seed.image,previewAsset:actionAssets[seed.id],attackEffectKind:seed.id==='gang'?'gang-rifle':undefined,status:actionAssets[seed.id]||seed.id==='gang'?'available':'planned',motion:'attack',accent:seed.accent,tags:[seed.family,'攻击',...(seed.id==='gang'?['举枪','步枪点射']:[])]},
 {id:`${seed.id}-death`,category:'enemy',family:seed.family,name:seed.family,level:'死亡',action:'死亡',description:seed.id==='riot'?'防暴镇压机液压系统失压，重盾先行坠地，机体跪倒后侧翻，并在地面留下机械零件。':seed.id==='ninja'?'相位忍者的隐身轮廓失稳，能量刀熄灭，身体跪倒后向侧面倒下。':'单位受到致命伤害后失去支撑，完成倒地并留下对应的死亡残留特效。',timeline:seed.id==='riot'?'致命受击 → 液压失压 → 重盾坠地 → 跪倒侧翻 → 零件残留':seed.id==='ninja'?'致命受击 → 相位失稳 → 能量刀熄灭 → 跪倒 → 侧向倒地':'致命受击 → 动作失衡 → 倒地 → 残留出现 → 淡出',referenceImage:seed.image,previewAsset:deathAssets[seed.id],previewFrames:undefined,status:deathAssets[seed.id]?'available':'planned',motion:'death',accent:seed.accent,tags:[seed.family,'死亡']},
] as AnimationCatalogEntry[]).filter((entry) => !entry.id.startsWith('adam-smasher-') && entry.id !== 'eve-death')

const adamSmasherStages:AnimationCatalogEntry[]=[
 {id:'adam-smasher-stage-1-move',category:'enemy',family:'亚当·重锤',name:'堡垒镇压',level:'初始形态',action:'行走',description:'堡垒形态保持低重心，以装甲重量驱动缓慢而稳定的重型步伐。',timeline:'左脚接触 → 重心下沉 → 右腿通过 → 身体抬升 → 右脚接触 → 循环',referenceImage:'/assets/enemies/boss-forms/adam-smasher-stage-1-fortress.png',previewAsset:'/assets/animations/enemies/boss-adam-smasher-move.webp?v=stage-cycle-20260826',status:'available',motion:'walk',accent:'#ff684f',tags:['亚当·重锤','初始形态','堡垒镇压','行走']},
 {id:'adam-smasher-stage-1-attack',category:'enemy',family:'亚当·重锤',name:'堡垒镇压',level:'初始形态',action:'攻击',description:'初始形态压低身体并举起义体重炮，完成蓄力、开火、后坐与复位。',timeline:'锁定 → 压低重心 → 举炮 → 开火 → 后坐 → 复位',referenceImage:'/assets/enemies/boss-forms/adam-smasher-stage-1-fortress.png',previewAsset:'/assets/animations/enemies/boss-adam-smasher-attack.webp?v=stage-cycle-20260826',status:'available',motion:'attack',accent:'#ff684f',tags:['亚当·重锤','初始形态','堡垒镇压','攻击']},
 {id:'adam-smasher-stage-2-move',category:'enemy',family:'亚当·重锤',name:'攻城超载',level:'二级形态',action:'行走',description:'肩部导弹仓展开后保持重装步态，双臂重武器随左右重心交替稳定摆动。',timeline:'左脚接触 → 装甲下沉 → 导弹仓稳定 → 右脚接触 → 推进器脉冲 → 循环',referenceImage:'/assets/animations/enemies/runtime/enforcer-stage-2/move/frame-01.webp',previewAsset:'/assets/animations/enemies/boss-adam-smasher-stage-2-move.webp?v=stage-cycle-20260826',status:'available',motion:'walk',accent:'#ff3b2f',tags:['亚当·重锤','二级形态','攻城超载','行走']},
 {id:'adam-smasher-stage-2-attack',category:'enemy',family:'亚当·重锤',name:'攻城超载',level:'二级形态',action:'攻击',description:'双臂旋转重炮与肩部弹仓同步校准，以短促齐射完成一次攻城超载打击。',timeline:'战斗姿态 → 重心下沉 → 双炮抬起 → 赤红蓄能 → 弹炮齐射 → 后坐散热 → 复位',referenceImage:'/assets/animations/enemies/runtime/enforcer-stage-2/attack/frame-01.webp',previewAsset:'/assets/animations/enemies/boss-adam-smasher-stage-2-attack.webp?v=stage-cycle-20260826',status:'available',motion:'attack',accent:'#ff3b2f',tags:['亚当·重锤','二级形态','攻城超载','攻击','弹炮齐射']},
 {id:'adam-smasher-stage-3-move',category:'enemy',family:'亚当·重锤',name:'核心暴露',level:'三级形态',action:'行走',description:'装甲破损与核心暴露后以略带失衡的重踏继续推进，胸口核心随步伐脉动。',timeline:'左脚重踏 → 肩部失衡 → 核心脉冲 → 右脚重踏 → 机体回正 → 循环',referenceImage:'/assets/animations/enemies/runtime/enforcer-stage-3/move/frame-01.webp',previewAsset:'/assets/animations/enemies/boss-adam-smasher-stage-3-move.webp?v=stage-cycle-20260826',status:'available',motion:'walk',accent:'#ff6158',tags:['亚当·重锤','三级形态','核心暴露','行走']},
 {id:'adam-smasher-stage-3-attack',category:'enemy',family:'亚当·重锤',name:'核心暴露',level:'三级形态',action:'攻击',description:'机体向内收束压缩暴露核心，释放紧贴胸口的核心爆震后承受剧烈后坐。',timeline:'受损姿态 → 双脚撑地 → 核心蓄能 → 白红过载 → 核心爆震 → 后坐 → 火花消退 → 复位',referenceImage:'/assets/animations/enemies/runtime/enforcer-stage-3/attack/frame-01.webp',previewAsset:'/assets/animations/enemies/boss-adam-smasher-stage-3-attack.webp?v=stage-cycle-20260826',status:'available',motion:'attack',accent:'#ff6158',tags:['亚当·重锤','三级形态','核心暴露','攻击','核心爆震']},
]

const unit=(id:string,category:'mercenary'|'drone',family:string,name:string,action:string,image:string,motion:AnimationMotion,accent:string,description:string):AnimationCatalogEntry=>({id,category,family,name,level:action,action,description,timeline:`准备 → ${action}主体动作 → 命中/落地反馈 → 收势`,referenceImage:image,previewFrames:Array.from({length:6},(_,index)=>`/assets/animations/units/runtime/${id.replace(`-${motion}`, '')}/${motion}/frame-${String(index+1).padStart(2,'0')}.png`),status:'available',motion,accent,tags:[family,name,action]})
...
export const ANIMATION_CATALOG:readonly AnimationCatalogEntry[]=[...towers,...enemies,...adamSmasherStages,...units]
