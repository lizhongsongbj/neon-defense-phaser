...
const enemies:AnimationCatalogEntry[]=enemySeeds.flatMap(seed=>[
 ...
 {id:`${seed.id}-death`,category:'enemy',family:seed.family,name:seed.family,level:'死亡',action:'死亡',description:'结构失稳后倒地或解体，使用材质碎屑、烟尘与残留物。',timeline:'致命伤 → 失稳 → 材质化崩解 → 残留',referenceImage:seed.image,previewAsset:deathAssets[seed.id],status:deathAssets[seed.id]?'available':'planned',motion:'death',accent:seed.accent,tags:[seed.family,'死亡']},
