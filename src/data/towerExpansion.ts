...
export const EXPANSION_TOWERS: readonly ExpansionTowerDefinition[] = [
  ...
  },
  {
    ...
    role: '群体解构 / 护甲削弱',
    accent: '#74e69a',
    image: 'assets/towers/new-concepts/revised/grey-tide-level-1.png',
    buildCost: 120,
    damageKind: 'energy',
    targetLayer: 'ground',
    researchDamageApplies: true,
  ...
  },
  {
    ...
    role: '路径回滚 / 延迟复写',
    accent: '#58cfff',
    image: 'assets/towers/new-concepts/revised/trajectory-rewriter-level-1.png',
    buildCost: 145,
    damageKind: 'energy',
    targetLayer: 'both',
    researchDamageApplies: true,
...
export const TIER4_BRANCH_IMAGE_BY_ID: Readonly<Record<string, string>> = {
  ...
  'drone-swarm-annihilator': 'assets/generated/cutout/drone-swarm-annihilator-2026-08-23T11-15-14-016Z.png',
  'drone-queen-air-carrier': 'assets/generated/cutout/drone-queen-air-carrier-2026-08-23T11-26-55-854Z.png',
