...
export class UIArtStudio {
  ...
  private previewMarkup(preset: UIArtPresetId) {
    ...
    return `${sharedTop}<div class="ui-command-layout"><aside><span>战区节点</span><button class="active">01 超级建筑4号</button><button>02 荒坂物流环</button><button>03 太平洲裂谷</button><button>04 城北黑区</button></aside><main><div class="ui-command-visual"><i></i><b>THREAT 1.40</b></div><span>MISSION // 01</span><h3>超级建筑4号</h3><p>守住双向数据节点，阻止帮派义体兵和防暴镇压机进入核心区。</p><div class="ui-command-chips"><i>12 波</i><i>5 塔位</i><i>标准难度</i></div><button>DEPLOY // 进入战区</button></main></div>`
  }
