...
const marker="const deathAssets:Record<string,string>="
const idx=s.indexOf(marker); if(idx<0) throw new Error('marker missing')
...
// Change generated attack/death preview assets to frame-01 and attach frame sequences dynamically in object literal.
...
// action/death maps use frame 01; currently they do. Ensure no issue.
...
const pos=a.indexOf("  private headPulseMarkup")
if(pos<0) throw new Error('method insertion point missing')
